package plaupi.statuspembayaran;
...
import plaupi.statuspembayaran.config.Config;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(MainActivity.this, labs.get(i), Toast.LENGTH_SHORT).show();
            }
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(MainActivity.this, year.get(i), Toast.LENGTH_SHORT).show();
            }
